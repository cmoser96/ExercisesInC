...
void pair_del (gpointer value, gpointer user_data)
{
    g_free(value);
    g_free(user_data);
}
...
int main (int argc, char** argv)
{
    ...
    gchar **array;
    gchar line[128];
    GHashTable* hash = g_hash_table_new_full (g_str_hash, g_str_equal, freeor, freeor);
    int i;
    ...
    g_sequence_foreach (seq,  (GFunc) pair_del, NULL);
